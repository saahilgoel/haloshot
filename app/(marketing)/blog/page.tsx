...
const posts = [
  ...
  },
  {
    ...
    excerpt: "In 1920, Thorndike discovered that attractive soldiers were rated as smarter and more capable. A century later, the same bias is judging your LinkedIn photo in 100 milliseconds.",
    category: "Science",
    date: "Apr 5, 2026",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "After scoring thousands of LinkedIn headshots, we found the seven characteristics that separate photos scoring 80+ from everything else.",
    category: "LinkedIn",
    date: "Apr 2, 2026",
    readTime: "6 min read",
